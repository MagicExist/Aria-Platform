...
[Answer]: A — Un solo código base con **React + Expo** (Expo/React Native cubre web + Android + iOS desde una sola base).
...
[Answer]: B — Android como APK instalado manualmente. Objetivo de distribución del MVP = **Android (APK sideload)**. Web e iOS salen del mismo código base Expo pero NO son el foco de distribución del MVP.
