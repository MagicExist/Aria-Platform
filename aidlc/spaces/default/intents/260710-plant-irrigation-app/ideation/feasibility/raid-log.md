...
| R-2 | iOS falla en runtime y no se detecta (sin pruebas locales) | Media | Bajo | iOS fuera del foco del MVP; apoyarse en Expo (paridad alta) y EAS Build; validar cuando haya acceso a Mac |
